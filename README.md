This project is for my final in Harvard cs50 online course.  The purpose is to gather a csv file from a user (web based).  Take that file and split out any rows that contain bad data.  
